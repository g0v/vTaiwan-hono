...
const filteredTopics = computed(() => {
  ...
  if (activeSteps.length > 0) {
    ...
    filtered = filtered.filter((topic) =>
      activeStatuses.includes(topic.status as (typeof STEP_KEYS)[number]),
    );
  }
...
<template>
  <section class="vt-hero-bg text-white">
    <div class="mx-auto max-w-5xl px-6 pb-24 pt-36 relative z-1">
      <div class="mx-auto max-w-7xl">
        ...
        <p class="mb-6 text-lg opacity-90">
          ...
          <RouterLink
            to="/polis"
            class="ml-1 inline-block font-medium text-democratic-red underline underline-offset-4 transition hover:text-white"
          >
        ...
        >
          ...
          >
            ...
            <div class="mb-5 flex items-start gap-4 pr-10">
              ...
              <div class="min-w-0">
                <h3
                  class="mb-2 line-clamp-2 text-[19px] font-bold leading-tight tracking-[-0.01em] text-vt-gray-800"
                >
                  {{ topic.title }}
                </h3>
                <div class="vt-topic-eyebrow flex-wrap">
                  ...
                  <span class="text-vt-fg-3"
                    >・{{ formatDate(topic.last_posted_at || topic.created_at) }}</span
                  >
                </div>
              </div>
            </div>
        ...
        <div class="max-w-md flex-1">
          <div class="relative">
            ...
            <IconWrapper
              name="search"
              :size="20"
              class="absolute left-4 top-1/2 -translate-y-1/2 transform text-gray-400"
            />
            <button
              v-if="searchQuery"
        ...
        <div class="flex w-full items-center justify-start gap-2 lg:justify-between">
          ...
          <button
            :class="[
              ...
              showBookmarksOnly
                ? 'bg-democratic-red text-white shadow-sm'
                : 'bg-gray-100 text-black hover:bg-gray-200',
            ]"
          ...
          >
            <IconWrapper
              name="bookmark"
              :size="18"
              :class="showBookmarksOnly ? 'fill-white' : 'fill-none'"
            />
    ...
    <div class="mx-auto px-2">
      <div class="mx-auto max-w-7xl">
        ...
        <div v-if="loading" class="py-12 text-center">
          <div
            class="mx-auto h-12 w-12 animate-spin rounded-full border-b-2 border-democratic-red"
          />
        ...
        <div v-else-if="filteredTopics.length > 0">
          <div
            v-if="filteredTopicsBigImg.length > 0"
          ...
          >
            ...
            >
              ...
              <div class="mb-5 flex items-start gap-4 pr-10">
                ...
                <div class="min-w-0">
                  <h3
                    class="mb-2 line-clamp-2 text-2xl font-bold leading-tight tracking-[-0.01em] text-vt-gray-800"
                  >
                    <RouterLink
                      :to="`/topic/${topic.routeName}`"
                      class="transition hover:text-democratic-red"
                    >
                      {{ topic.title }}
                    </RouterLink>
                  </h3>
              ...
              <div class="mb-4 flex flex-1 flex-col">
                <p
                  v-if="topic.slogan"
                  class="mb-5 line-clamp-3 text-base leading-[1.65] text-vt-fg-2"
                >
                  {{ topic.slogan }}
                </p>
              ...
              <div class="mt-auto">
                <RouterLink
                  ...
                  class="vt-btn vt-btn-primary w-full justify-center text-center"
                >
          ...
          >
            ...
            >
              ...
              <div class="mb-4 flex items-start gap-3 pr-10">
                ...
                <div class="min-w-0">
                  <h3
                    class="mb-2 line-clamp-2 text-[17px] font-bold leading-tight tracking-[-0.01em] text-vt-gray-800"
                  >
                    {{ topic.title }}
                  </h3>
                  <div class="vt-topic-eyebrow flex-wrap">
              ...
              <div class="flex flex-1 flex-col">
                <p
                  v-if="topic.slogan"
                  class="mb-4 line-clamp-2 text-sm leading-[1.55] text-vt-fg-2"
                >
                  {{ topic.slogan }}
                </p>
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    >
                      <IconWrapper
                        ...
                        :class="
                          isBookmarked(topic)
                            ? 'fill-democratic-red text-democratic-red'
                            : 'text-gray-400 hover:text-democratic-red'
                        "
                      />
                    </button>
                  </div>
