<template>
  <div class="flex h-screen w-full">
    <!-- 視訊會議區域 -->
    <div
      :class="['transition-all duration-300', showTranscript && !isMobile ? 'w-[62%]' : 'w-full']"
    >
      <!-- 加入會議按鈕 -->
      <div v-if="!hasJoined" class="flex h-full items-center justify-center bg-gray-100">
        <div class="text-center">
          ...
          <br />
          <p v-if="!userData || !userData.uid" class="text-sm text-gray-600">
    ...
    >
      <div
        class="mx-2 max-h-[90vh] w-[95vw] max-w-md overflow-y-auto rounded-lg bg-white shadow-xl"
        @click.stop
      >
        <div class="p-4 sm:p-1">
              ...
              <div
                ...
                :class="
                  selectedAudioDeviceId === device.deviceId
                    ? 'border-democratic-red bg-democratic-red/5'
                    : 'border-gray-200 hover:border-gray-300'
                "
              >
                <div
                  class="flex cursor-pointer items-center p-4 sm:p-1"
                  ...
                  <div class="mr-3 shrink-0">
                    ...
                    >
                      <div
                        ...
                        class="h-2 w-2 rounded-full bg-democratic-red"
                      ></div>
                    </div>
                  </div>
                  <div class="flex-1">
                ...
                <div
                  ...
                  class="px-4 pb-4 sm:px-3 sm:pb-3"
                >
            ...
            <button
              ...
              :class="
                isTestingAudio
                  ...
                  : 'bg-jade-green hover:bg-jade-green/90'
              "
            >
          ...
          <div class="flex space-x-3">
            <button
              ...
              class="flex-1 rounded-lg bg-democratic-red px-4 py-3 text-white transition-colors hover:bg-democratic-red/90 sm:py-2"
            >
              {{ $t("common.save") }}
            </button>
            <button
              @click="hideAudioSettings"
              class="flex-1 rounded-lg bg-gray-300 px-4 py-3 text-gray-700 transition-colors hover:bg-gray-400 sm:py-2"
            >
              {{ $t("common.cancel") }}
            </button>
          </div>
    ...
    <div class="fixed bottom-16 right-6 z-50 flex flex-col space-y-3">
      <div class="relative">
        ...
        >
          ...
          <div
            v-if="isMobile"
            class="z-15 absolute -right-1 top-10 flex h-5 w-5 items-center justify-center rounded-full bg-white text-sm shadow-xs"
      ...
      <div class="relative">
        ...
        >
          ...
          <div
            ...
            class="absolute -left-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full border-2 border-red-500 bg-white text-xs font-bold text-red-500"
          >
            {{ recordingTimeLeft }}
          </div>
          <div
        ...
        >
          ...
          <div
            v-if="!isMobile"
            class="z-15 absolute -right-1 top-4 flex h-5 w-5 items-center justify-center rounded-full bg-white text-sm shadow-xs"
            :title="`轉錄語言: ${transcriptionLanguage}`"
          >
            {{ transcriptionLanguageFlag }}
          </div>
    ...
    >
      <div
        class="flex items-start space-x-3 rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-3 text-yellow-900 shadow-sm"
      >
        ...
        <button
          ...
          class="ml-2 text-yellow-900/70 transition-colors hover:text-yellow-900"
  ...
  methods: {
    ...
    async getJwt() {
      ...
      const res = await fetch(
        `/api/jitsi-token?room=vtaiwan&user_id=${user_id}&user_name=${user_name}&user_email=${user_email}&user_moderator=${isAdmin}`,
      );
    ...
    onDrag(event) {
      ...
      this.drawerWidth = Math.max(
        300,
        Math.min(window.innerWidth * 0.8, this.dragStartWidth + deltaX),
      );
    },
