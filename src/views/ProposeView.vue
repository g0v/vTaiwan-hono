<template>
  ...
  <section class="bg-black py-12 text-white">
    <div class="container mx-auto px-4">
      <h1 class="mb-4 text-3xl font-bold md:text-4xl vt-title-underline">{{ t('propose.title') }}</h1>
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-start space-x-4">
              <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-democratic-red/10">
                <IconWrapper name="video" :size="24" type="primary" />
              </div>
              <div>
            ...
            <div class="flex items-start space-x-4">
              <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-jade-green/10">
                <IconWrapper name="users" :size="24" type="teal" />
              </div>
              <div>
          ...
          <div class="grid gap-6 md:grid-cols-2">
            <div class="rounded-lg bg-white p-6">
              <div class="mb-4 flex items-center">
                <IconWrapper name="calendar" :size="20" type="primary" class="mr-3" />
              ...
              <RouterLink to="/meetups" class="vt-btn-primary inline-block rounded-md">
            ...
            <div class="rounded-lg bg-white p-6">
              <div class="mb-4 flex items-center">
                <IconWrapper name="message" :size="20" type="teal" class="mr-3" />
              ...
              <RouterLink to="/contact" class="vt-btn-secondary inline-block rounded-md">
