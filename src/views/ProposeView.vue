<template>
  <div class="vt-under-navbar">
    <!-- Hero Section -->
    <section class="bg-black pt-36 pb-16 text-white">
          ...
          <div class="rounded-lg bg-gray-50 p-8">
            ...
            <div class="grid gap-6 md:grid-cols-2">
              <div class="rounded-lg bg-white p-6">
                ...
                <RouterLink to="/meetups" class="vt-btn vt-btn-primary inline-flex">
              ...
              <div class="rounded-lg bg-white p-6">
                ...
                <RouterLink to="/contact" class="vt-btn vt-btn-outline inline-flex">
