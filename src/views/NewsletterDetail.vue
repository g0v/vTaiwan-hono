<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-else-if="error" class="rounded-xl border border-red-200 bg-red-50 p-6 text-center">
      ...
      <RouterLink
        to="/newsletters"
        class="mt-4 inline-flex text-sm font-medium text-democratic-red hover:underline"
      >
    ...
    <article v-else-if="newsletter" class="mx-auto max-w-4xl">
      <RouterLink
        to="/newsletters"
        class="mb-6 inline-flex text-sm font-medium text-democratic-red hover:underline"
      >
        {{ t("newsletter.backToList") }}
      </RouterLink>

      <img
        v-if="newsletter.coverImage"
      ...
      <header class="mb-8 border-b border-gray-200 pb-6">
        <p class="mb-3 text-sm text-gray-500">
          <span v-if="newsletter.author">{{ newsletter.author }} · </span
      ...
      <footer class="mt-10 border-t border-gray-200 pt-6">
        <RouterLink
          to="/newsletters"
          class="inline-flex text-sm font-medium text-democratic-red hover:underline"
        >
          {{ t("newsletter.backToList") }}
        </RouterLink>
      </footer>
