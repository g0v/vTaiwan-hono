      ...
      <section class="mb-12">
        ...
        <div class="space-y-6">
          <div
            v-for="faq in faqs"
            :key="faq.id"
            class="overflow-hidden rounded-lg border border-vt-border bg-white p-6 shadow-xs transition hover:shadow-md"
          >
          ...
          <div class="rounded-lg bg-vt-gray-100 p-6">
            ...
            <p class="flex items-center">
              <svg
                ...
                class="mr-2 h-5 w-5 text-democratic-red"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <a href="mailto:info@vtaiwan.tw" class="transition hover:text-democratic-red"
                >info@vtaiwan.tw</a
              >
            </p>
          </div>
          ...
          <div class="rounded-lg bg-vt-gray-100 p-6">
            ...
            <div class="space-y-2">
              ...
              <p class="flex items-center">
                ...
                <a
                  href="https://facebook.com/vtaiwan.tw"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="transition hover:text-democratic-red"
                  >vTaiwan</a
