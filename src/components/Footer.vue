  ...
  <footer class="vt-footer-bg relative font-serif text-[#d8d8de]">
    ...
    <div class="mx-auto max-w-6xl px-6 pb-6 pt-10">
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          <img
            :src="'/assets/vtaiwan-logo-dark.svg'"
            alt="vTaiwan"
            class="mb-3 h-6 w-auto opacity-95"
          />
        ...
        <div>
          <div
            class="mb-2.5 flex h-7 items-center gap-2 font-sans text-[11px] font-semibold uppercase tracking-[0.14em] text-[#e4e4ea]"
          >
            <span
              class="h-[5px] w-[5px] rounded-full bg-democratic-red shadow-[0_0_6px_rgba(216,0,0,0.55)]"
            />
      ...
      <div
        class="relative mt-7 flex flex-col md:flex-row items-center justify-between gap-x-5 gap-y-3 pt-4 font-sans text-xs text-[#76767e]"
      >
        <span class="vt-hairline absolute inset-x-0 top-0 h-px" />
