...
const plinkList = computed(() => [
  { icon: 'link', title: t('topics.timeline.linkTypes.related'), desc: t('topics.timeline.linkTypes.relatedDesc') },
  { icon: 'edit', title: t('topics.timeline.linkTypes.hackpad'), desc: t('topics.timeline.linkTypes.hackpadDesc') },
  { icon: 'book', title: t('topics.timeline.linkTypes.record'), desc: t('topics.timeline.linkTypes.recordDesc') },
  { icon: 'play', title: t('topics.timeline.linkTypes.live'), desc: t('topics.timeline.linkTypes.liveDesc') },
  { icon: 'users', title: t('topics.timeline.linkTypes.discuss'), desc: t('topics.timeline.linkTypes.discussDesc') },
  { icon: 'message-circle', title: t('topics.timeline.linkTypes.comment'), desc: t('topics.timeline.linkTypes.commentDesc') },
])
...
<template>
  <div class="topic-timeline overflow-x-auto">
    ...
    <div v-else-if="timeline.length > 0">
      ...
      <div class="mt-8">
        <h3 class="mb-4 text-lg font-semibold text-gray-900">{{ t('topics.timeline.externalLinksTitle') }}</h3>
