  ...
  <div class="topic-discussion-comment">
    ...
    <div v-else-if="comments.length > 0" class="space-y-6">
      ...
      <div class="border-t border-gray-200 pt-6 text-center">
        <a :href="`https://talk.vtaiwan.tw/t/topic/${commentId}`" target="_blank" rel="noopener noreferrer" class="vt-btn vt-btn-primary inline-flex items-center">
    ...
    <div v-else class="py-8 text-center">
      ...
      <a :href="`https://talk.vtaiwan.tw/t/topic/${commentId}`" target="_blank" rel="noopener noreferrer" class="vt-btn vt-btn-primary mt-4 inline-flex items-center">
        <IconWrapper name="edit" :size="20" class="mr-2" />
